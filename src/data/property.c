...
void print_property2(Property2* property) {
    ...
    println("Subject - %llu", property->subject_id);
...
void write_property2_to_file_big(Cursor* cursor, PageHeader* page_header, Entity* entity, void* pr, const uint64_t* pointer) {
    ...
    entity->next_id += 1;
    page_header->offset += UINT32_T_SIZE * 5;
    ...
    write_big_string_to_file(cursor, page_header, entity, property->key_length, property->key);
...
void* read_property2(Cursor* cursor, Entity* meta_page, PageHeader* page_header, void* element, const uint64_t* offset_, char* body, uint32_t* read_block) {
        ...
        read_big_string_from_file(cursor, page_header, body, key, key_length, &(offset), read_block);
...
uint64_t get_size_of_property2(void* pr) {
    Property2* property = (Property2*) pr;
    return UINT32_T_SIZE * 4 + CHAR_SIZE * (property->key_length + property->value_length) + VALUE_TYPE_SIZE;
}

bool compare_property2(void* pr_1, void* pr_2) {
    Property2* property_1 = (Property2*) pr_1;
    Property2* property_2 = (Property2*) pr_2;
    return property_1->subject_id == property_2->subject_id && strcmp(property_1->key, property_2->key) == 0
     && strcmp(property_1->value, property_2->value) == 0;
}
...
bool compare_key_property2(void* pr_1, void* pr_2) {
    Property2* property_1 = (Property2*) pr_1;
    Property2* property_2 = (Property2*) pr_2;
    return strcmp(property_1->key, property_2->key) == 0;
}
...
void* memget_property2(void* element, Entity* metaPage, char* stack, uint64_t* offset) {
    ...
    *offset += CHAR_SIZE * value_length;
    ...
    property->id = id;
    property->subject_id = subject_length;
    property->key_length = key_length;
    property->key = key;
    property->value_type = value_type;
    property->value_length = value_length;
